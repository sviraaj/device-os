...
enum MeshNCPManufacturer {
    ...
    MESH_NCP_MANUFACTURER_QUECTEL = 3
};
...
enum MeshNCPIdentifier {
	...
	MESH_NCP_QUECTEL_BG96 = MESH_NCP_IDENTIFIER(MESH_NCP_MANUFACTURER_QUECTEL, 5),
	MESH_NCP_QUECTEL_EG91 = MESH_NCP_IDENTIFIER(MESH_NCP_MANUFACTURER_QUECTEL, 6)
};
